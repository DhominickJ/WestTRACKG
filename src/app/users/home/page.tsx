    ...
    <>
      ...
      <div className="justify-start h-[325px] w-full bg-homeLightBlueBG bg-opacity-[0.2] p-16 pl-[112px] pt-8 pb-0">
        ...
        <div className="flex flex-row mt-4 justify-evenly ">
          <Link href="/users/upload">
            <div className="first w-[180px] mt-2 justify-center align-middle">
              ...
              <p className="mt-3 text-[12px] truncate">
                {" "}
                {/* 'truncate' class will apply the necessary styles */}
                Add File
              </p>
            </div>
          </Link>

          <div className="second w-[180px] mt-2 justify-center align-middle">
            {" "}
            {/* Set a fixed width for the container */}
            <Image
              ...
              onClick={() => {
                downloadPdf(
                  "/pdf_templates/StudentOrganizations/Application for Approval-Accreditation of Student Organizations.pdf"
                );
          ...
          <div className="fourth w-[180px] mt-2 justify-center align-middle">
            {" "}
            {/* Set a fixed width for the container */}
            <Image
              ...
              onClick={() => {
                downloadPdf(
                  "/pdf_templates/StudentOrganizations/Parents-Guardians Consent.pdf"
                );
                alert("Downloaded File");
              }}
              className="cursor-pointer"
          ...
          <div className="fifth w-[180px] mt-2 justify-center align-middle">
            {" "}
            {/* Set a fixed width for the container */}
            <Image
              ...
              onClick={() => {
                downloadPdf(
                  "/pdf_templates/StudentOrganizations/Permit B to Conduct Non-Academic Student Activities Off-Campus.pdf"
                );
                alert("Downloaded File");
              }}
              className="cursor-pointer"
          ...
          <div className="sixth w-[180px] mt-2 justify-center align-middle">
            {" "}
            {/* Set a fixed width for the container */}
            <Image
              ...
              onClick={() => {
                downloadPdf(
                  "/pdf_templates/StudentOrganizations/Permit B to Conduct Non-Academic Student Activities Within Campus.pdf"
                );
                alert("Downloaded File");
              }}
              className="cursor-pointer"
